...
The eval component is never the trust root. The watchdog generates the
per-restart HMAC signing key and distributes it via env var
(`EUGENE_PLEXUS_EVAL_AUTH_SIGNING_KEY`). This module exposes just the
